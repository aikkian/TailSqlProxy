...
/// In the TDS Login7 packet, TypeFlags is at offset 26 (1 byte).
...
{
    // TypeFlags byte is at offset 26 in the Login7 payload (MS-TDS 2.2.6.4)
    // Layout: Length(4) + TDSVersion(4) + PacketSize(4) + ClientProgVer(4) +
    //         ClientPID(4) + ConnectionID(4) + OptionFlags1(1) + OptionFlags2(1) + TypeFlags(1)
    private const int TypeFlagsOffset = 26;
